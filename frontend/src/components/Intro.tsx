    ...
    <div className="grid grid-cols-2 gap-y-2.5 p-6 justify-center justify-items-center justify-self-center bg-intro-background">
      <div className="flex flex-col gap-y-2.5 align-self-center">
        <div className="flex flex-col gap-y-4 align-self-center">
          <h1 className="font-baloo font-extrabold leading-tight text-5xl">
            Encontre o café perfeito para qualquer hora do dia
          </h1>
          <p className="text-xl leading-tight antialiased text-amber-950">
        ...
        <div className="flex mt-2">
          <div className="grid grid-cols-2 gap-y-5 gap-x-10">
            <div className="flex items-start justify-center">
              ...
              <p className="text-base font-normal antialiased text-amber-950 ml-2">
      ...
      <img
        ...
        src={coffeeImage}
        alt="Imagem de um copo de café com grãos ao fundo"
      />
    </div>
  );
}
